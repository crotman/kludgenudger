...
Considering 30 open code java projects, 21 projects have significantly more PMD Alerts among methods with SATD comments (P-Value \< 0.05). No project shows significantly less. In other 9 projects there is no significant difference.
...
The prevalence of methods containg SATD comments is not high: the median proportion in 30 projects is 2.5%.
...
The effect of the presence of SATD on probability of PMD Alert is approximately 6pp
